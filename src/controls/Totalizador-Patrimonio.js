...
class Totalizador_Patrimonio extends Component {
    ...
    return (
      <View>
        <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center', marginTop: '3%' }}>
          ...
          > */}
          <Text style={{ fontSize: 18, color: 'transparent', textAlign: 'center', fontWeight: 'bold', margin: 5 }}>{p_mascara}</Text>
          {/* </Item> */}
          {/* <Item
            regular
            style={{
          ...
          > */}
          <Text style={{ fontSize: 18, color: 'transparent', textAlign: 'center', fontWeight: 'bold', margin: 5 }}>{n_mascara}</Text>
          {/* </Item> */}
        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(Totalizador_Patrimonio);