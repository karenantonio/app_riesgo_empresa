...
class ObservacionGral extends React.Component {
  ...
  render() {
    return (<View>
      <Grid style={{ borderColor: "grey", borderWidth: 1, borderRadius: 10, margin: 5, padding: 10, marginTop: '5%' }}>
        ...
        <ScrollView keyboardShouldPersistTaps={'handled'}>
          <View style={{ marginTop: 10, paddingLeft: 10, paddingRight: 10, alignItems: 'center' }}>
            ...
            <View style={{ marginTop: '5%' }}>
              ...
              <Label style={{ fontSize: 18, color: this.props.theme.primary }}>{this.state.titulo_obs}</Label>
            </View>
...
export default connect(null, mapDispatchToProps)(ObservacionGral);